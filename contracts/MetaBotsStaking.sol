    ...
    ReentrancyGuardUpgradeable
{
        ...
        initializer
    {
		...
		configuredLocks.push(ConfiguredLock(30 days, 600));
		configuredLocks.push(ConfiguredLock(365 days, 1500));
    }
    ...
    function stake(uint256 _amount, uint256 _configuredLock) external {
		...
		require(_amount >= 50000 * (10**18), "The minimum staking amount is 20.000 tokens");
